<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Digital Marketing");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Best Digital Marketing Training institute in US, India</title>
    <meta property="og:title" content="Best Digital Marketing Training institute in US, India"/>
	<meta property="og:url" content="https://www.technoreachit.com/digital-marketing-training.jsp"/>
	<meta property="og:description" content="Master your skills in SEO, SMM, Google Adwords, Google Analytics, Affiliate Marketing, Artificial Intelligence in Digital Marketing and more!"/>
    ...
    <link rel="canonical" href="https://technoreachit.com/digital-marketing-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/digital-marketing.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
