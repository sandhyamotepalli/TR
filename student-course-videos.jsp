<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    int user = (int)session.getAttribute("registereduserid");
    AdminBean userDetails = adminDao.getRegisteredUserDetailsById(user);
	AdminBean videoBean = new AdminBean();
	ArrayList<AdminBean> videoDetails = adminDao.getStudentsVideosList(userDetails.getTrainingid(),userDetails.getBatchnumber());
    %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="canonical" href="https://technoreachit.com/student-course-videos.jsp">
    <!-- Favicon -->
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right" id="top-menu">
                                <li><a href="<%=request.getContextPath()%>/index-student.jsp">Home</a></li>
                                <li class="active"><a href="<%=request.getContextPath()%>/student-course-videos.jsp">Course Videos</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li><a href="<%=request.getContextPath()%>/index-student.jsp"><i class="fa fa-home"></i> Home</a></li>
									...
									for(int i=0;i<videoDetails.size();i++)
									{
										 if (videoDetails.get(i) != null)
										{
											 ...
											 videoBean = videoDetails.get(i);
												 ...
												 {%>
												 <li><a href="javascript:getTrainingVideo('<%=videoBean.getVideoid()%>');"><%=i+1%>. <%=videoBean.getVideoheading()%></a></li>
										      <%  }
								            }
										 videoBean = null;
						 	          }
