<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Internet of Things(IoT)");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Internet of Things (IoT) Training | Certification Course | TechnoReach</title>
    <meta property="og:title" content="Internet of Things (IoT) Training | Certification Course | TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/internet-of-things-training.jsp"/>
	<meta property="og:description" content="In this course, you will learn basics of IoT, IoT System Architecture, Building IoT using Raspberry PI Board and more!"/>
    ...
    <link rel="canonical" href="https://technoreachit.com/internet-of-things-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!-- <h6 class="tr-font-white tr-tw-5">The institute is providing a career-oriented online Internet of Things (IoT) training course that lets you learn the complete aspects of the IoT technology. </h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/iot.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
