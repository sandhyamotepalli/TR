<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    adminBean = adminDao.getTrainingContentDetailsById(Integer.parseInt(tid));
    %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="canonical" href="https://technoreachit.com/edit-training-content.jsp">
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row">
                    <div class="contact-form">
                        <div class="col-sm-6">
                                <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/UpdateTrainingContent">
                                <div class="section-field">
                                <input type="hidden" placeholder="Course Title" name="ucontentid" value='<%=adminBean.getContentid()%>' required>
                                </div>
                                <div class="section-field textarea tr-mb-20">
                                    <textarea class="input-message" placeholder="Trainer Info" rows="7" name="utrainercontent" required><%=adminBean.getTrainingcontent()%></textarea>
                                </div>
