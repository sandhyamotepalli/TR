<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Business Analyst");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Business Analyst Training in India, California | Analytics Certified</title>
    <meta property="og:title" content="Business Analyst Training in India, California | Analytics Certified"/>
	<meta property="og:url" content="https://www.technoreachit.com/business-analyst-training.jsp"/>
	<meta property="og:description" content="In this course , you will learn to understand business needs, assess the impact of those needs, performing gap analysis and more."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/business-analyst-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/business-analyst.jpg" />
                            </div>
                        </div>
                    </div>
                   <ul class="breadcrumb">
