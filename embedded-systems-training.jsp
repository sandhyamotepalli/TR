<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Embedded Systems");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Embedded Systems Online & Classroom Training in India</title>
    <meta property="og:title" content="Embedded Systems Online & Classroom Training in India"/>
	<meta property="og:url" content="https://www.technoreachit.com/embedded-systems-training.jsp"/>
	<meta property="og:description" content="This course offers training in basic concepts of embedded systems, Microcontroller/ Microprocessor Architecture and more. Contacts us for a free demo."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/embedded-systems-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/embedded-systems.jpg" />
                            </div>
                        </div>
                    </div>
                   <ul class="breadcrumb">
