...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Good Product development company in India - TechnoReach IT Solutions</title>
    <meta property="og:title" content="Good Product development company in India- TechnoReach IT Solutions"/>
	<meta property="og:url" content="https://www.technoreachit.com/our-clients.jsp"/>
	<meta property="og:description" content="We have a good number of clients based out of the USA, Thailand, Japan & other parts of the world with a 100% client success rate."/>
	
	<meta property="twitter:title" content="Good Product development company in India- TechnoReach IT Solutions"/>
	<meta property="twitter:url" content="https://twitter.com/technoreachit"/>
	<meta property="twitter:description" content="We have a good number of clients based out of the USA, Thailand, Japan & other parts of the world with a 100% client success rate."/>
	
	<meta property="facebook:title" content="Good Product development company in India- TechnoReach IT Solutions"/>
	<meta property="facebook:url" content="https://www.facebook.com/TechnoReach-It-Solutions-Pvt-Ltd-1188702097835525"/>
	<meta property="facebook:description" content="We have a good number of clients based out of the USA, Thailand, Japan & other parts of the world with a 100% client success rate."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/our-clients.jsp">
    <!-- Favicon -->
...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           <ul class="nav navbar-nav navbar-right" id="top-menu">
                               <li><a href="<%=request.getContextPath()%>/index.jsp">Home</a></li>
                                ...
                                <li   class="active"><a href="<%=request.getContextPath()%>/our-clients.jsp">Our Clients</a></li>
    ...
    <!-- Intro Start -->
    <section class="tr-breadcrumb overview-block-pt text-center tr-bg tr-bg-fixed tr-over-black-90 tr-box-shadow" style="background: url(images/screens-images/ourclients-bg.jpg);" >
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title tr-breadcrumb-title tr-mtb-100">
                            <h1 class="title tr-tw-8 tr-font-white">Our Clients</h1>
            ...
            <div class="container">
                <div class="row tr-mt-20">
                    <div class="col-sm-6 col-md-6 text-center">
                        <img src="images/clients/redcubetechnologies.png" style="width:90px;height:78px;" />
                        <h6>Red Cube Technologies, Thailand</h6>
                    </div>
                </div>
            </div>
        </section>
