...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <title>Careers | TechnoReach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/careers-admin.jsp">
    <!-- Favicon -->
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
        	document.getElementById("did").value = jid;
...
<body>
            ...
            <div class="container">
                <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 text-right tr-mb-20">
                        <a class="button tr-mt-15" href="<%=request.getContextPath()%>/careers-form.jsp">Post a Job</a>
                    </div>
                    ...
                    if(careerDetails != null && careerDetails.size() > 0){
                      	    ...
                      	    <div class="tr-client white-bg" style="border:1px solid #ddd;">
                                ...
                                <p class="tr-mb-0 text-right"><a class="tr-mt-15 text-danger" href="javascript:deleteJob('<%=adminBean.getCareersid()%>')"><i class="fa fa-trash"></i> Delete</a></p>
                            </div>
                        </div>
    ...
    <form name="delform" id="delform" action="<%=request.getContextPath()%>/DeleteCareersService">
    <input type="hidden" name="careersid" id="cid">
    </form>
    <div class="footer">
        <!-- Footer Start -->
