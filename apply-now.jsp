...
<head>
    ...
    <title>Job Apply | TechnoReach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/apply-now.jsp">
    <!-- Favicon -->
...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                              <ul class="nav navbar-nav navbar-right" id="top-menu">
                               <li><a href="<%=request.getContextPath()%>/index.jsp">Home</a></li>
                                ...
                                <li><a href="<%=request.getContextPath()%>/our-trainings.jsp">Our Trainings & Courses</a></li>
    ...
    <!-- Intro Start -->
    <section class="tr-breadcrumb overview-block-pt text-center tr-bg tr-bg-fixed tr-over-black-90 tr-box-shadow" style="background: url(images/screens-images/contactus.jpg);" >
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="container">
                <div class="row tr-mt-20">
                    <div class="contact-form">
                        <div class="col-sm-6">
                            <form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/CareersService" enctype="multipart/form-data">
                                <div class="row">
	                                <div class="section-field col-md-12">
	                                    <input type="number" placeholder="JobCode*" name="jobcode" required>
	                                </div>
	                                <div class="section-field col-md-12">
	                                    <input type="text" placeholder="Full Name*" name="fullname" required pattern="[a-zA-Z ]*$" title="Name should be alphabets">
	                                </div>
	                                <div class="section-field col-md-4">
	                                    <input type="text" placeholder="Contact Number*" name="contactnumber" required pattern="[0-9]{10}" title="Should be 10 digits">
	                                </div>
	                                <div class="section-field col-md-8">
	                                    <input type="email" placeholder="Email ID*" name="emailid" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Please enter valid emailid" >
	                                </div>
	                                <div class="section-field col-md-4">
	                                    <input type="text" placeholder="Job Location Preference" name="joblocation" >
	                                </div>
	                                <div class="section-field col-md-4">
	                                    <input type="number" placeholder="Total IT Experience" name="itexperience" >
	                                </div>
	                                <div class="section-field col-md-4">
	                                    <input type="number" placeholder="Relevant Experience" name="relevantexperience" >
	                                </div>
	                                <div class="section-field col-md-6">
	                                    <input type="file" accept=".doc, .docx,.txt,.pdf"  name="resume">
	                                </div>
	                                <div class="section-field col-md-4">
	                                    <p><font color="red">Upload CV (Accepts only .doc)</font></p>
	                                </div>
	                                <div class="section-field col-md-12 textarea tr-mb-0">
	                                    <textarea class="input-message" placeholder="Message" rows="7" name="message"></textarea>
	                                </div>
	                                <div class="section-field col-md-12 tr-mb-20">
	                                	<button id="submit" name="submit" type="submit" value="SEnd" class="button pull-right tr-mt-20">Apply Now</button>
	                                </div>
                                </div>
                                
                            </form>
                        </div>
                        <div class="col-sm-6 text-center tr-mt-50">
                            <img src="images/careers-right-side.png" style="width: 100%;" />
                        </div>
                    </div>
                </div>
            </div>
