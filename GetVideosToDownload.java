...
/**
 * Servlet implementation class GetVideosToDownload
 */
@WebServlet("/GetVideosToDownload")
public class GetVideosToDownload extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetVideosToDownload() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(getVideo != null && getVideo.getVideoid() !=0 && getVideo.getVideoid() == Integer.parseInt(videoid)){
			    ...
			    htmlBuilder.append("<video width=\"100%\" height=\"500\" controls>");
