<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("DevOPS");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DevOps Online Training |DevOps Classroom training in Hyderabad</title>
    <meta property="og:title" content="DevOps Online Training |DevOps Classroom training in Hyderabad"/>
	<meta property="og:url" content="https://www.technoreachit.com/devops-training.jsp"/>
	<meta property="og:description" content="Azure DevOps is everything you need to build a software product from beginning to end."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/devops-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!-- <h6 class="tr-font-white tr-tw-5">Are you curious to learn both Azure and DevOps? If yes, here’s an amazing Training course for you.</h6> -->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/azure-devops.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
