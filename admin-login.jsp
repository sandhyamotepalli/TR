...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin Login - Techno Reach IT Solutions</title>
     <link rel="canonical" href="https://technoreachit.com/admin-login.jsp">
        ...
        <div class="loginbg">
            <div class="row loginbodybg loginbtnclass">
               <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/LoginService">
                ...
                <div class="col-xs-12 text-center bottom-ten signsubtext text-left"><a href="<%=request.getContextPath()%>/forgot-password.jsp">Forgot Password?</a></div>
