...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Post a Job | TechnoReach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/careers-form.jsp">
    <!-- Favicon -->
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right" id="top-menu">
                                ...
                                <li class="active"><a href="<%=request.getContextPath()%>/careers-admin.jsp">Careers</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title tr-breadcrumb-title tr-mtb-100">
                            <h1 class="title tr-tw-8 tr-font-white">Post a Job</h1>
                            <div class="divider white"></div>
                        </div>
                    <ul class="breadcrumb">
                        <li><a href="<%=request.getContextPath()%>/careers-admin.jsp"><i class="fa fa-list"></i> Careers</a></li>
            ...
            <div class="container">
               <div class="row tr-mt-20">
                    <div class="contact-form">
                        <div class="col-sm-6">
                        	 <form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/CreateCareerService">
                                <div class="section-field">
                                    <input type="number" placeholder="job code" name="jobcode" required>
                                </div>
                                <div class="section-field">
                                ...
                                <div class="section-field textarea">
                                    <textarea class="input-message tr-mb-20" placeholder="Description" rows="7" name="description1" required></textarea>
                                </div>
                                <div class="section-field textarea">
                                    <textarea class="input-message tr-mb-20" placeholder="Description" rows="3" name="description2" ></textarea>
                                </div>
                                <div class="section-field textarea">
                                    <textarea class="input-message tr-mb-20" placeholder="Description" rows="3" name="description3" ></textarea>
                                </div>
                                <div class="section-field">
                                	<button id="submit" name="submit" type="submit" value="SEnd" class="button pull-right tr-mb-20">Submit</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-sm-6 text-center">
                            <img src="images/careers-right-side.png" class="" style="width: 75%;">
                        </div>
                    </div>
                </div>
            </div>
