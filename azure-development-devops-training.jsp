<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Azure Development & DevOps");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Azure Development & DevOps Training in Dallas & India| TechnoReach</title>
    <meta property="og:title" content="Azure Development & DevOps Training in Dallas & India| TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/azure-development-devops-training.jsp"/>
	<meta property="og:description" content="In this course you will learn the basics of Azure, Azure App Service, Web Jobs, App Insights- Monitering & Trobleshooting, Cosmos DB, CDN and Functions of Azure."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/azure-development-devops-training.jsp">
    <!-- Favicon -->
                            ...
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                        <h1 class="tr-font-white"><%=adminBean.getCoursename()%></h1>
                                        <!-- <h6 class="tr-font-white tr-tw-5">Level up your Azure skills with the Microsoft Azure Certification course</h6> -->
