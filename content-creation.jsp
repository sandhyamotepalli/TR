...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Our Payments | TechnoReach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/content-creation.jsp">
    <!-- Favicon -->
            ...
            <div class="container">
                 <div class="row tr-mt-20">
                    <div class="contact-form">
                        <div class="col-sm-6">
                           <form name ="contentform" id ="contentform" action="<%=request.getContextPath()%>/CreateContentService" method="post">
                                 <div class="section-field select">
                                    <select name="trainingid" class="tr-mb-20" required>
								...
								for(int i=0;i<trainingDetails.size();i++)
								{
									 if (trainingDetails.get(i) != null)
									{
										 ...
										 adminBean = trainingDetails.get(i);
											 ...
											 {%>
                                        <option value='<%=adminBean.getTrainingid()%>'><%=adminBean.getCoursename()%></option>
									      <%  }
							            }
									 adminBean = null;
					 	          }
                           ...
                           <% }
					    	%>
                                ...
                                <div class="section-field textarea">
                                    <textarea class="input-message rich-editor tr-mb-10" placeholder="Content" rows="10" name="trainingcontent" required=""></textarea>
                                </div>
