<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("UI-UX DESIGN");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Complete Web & App Design Training| UX -UI Design| TechnoReach</title>
    <meta property="og:title" content="Complete Web & App Design Training| UX -UI Design| TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/ui-ux-design-training.jsp"/>
	<meta property="og:description" content="In this UX-UI Certification course, you will master in CSS, CSS3, Bootstrap, JQuery, JAVASCRIPT, DOM through Online or Classroom Training."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/ui-ux-design-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                      ...
                                      <!--  <h6 class="tr-font-white tr-tw-5">Our UI-UX Design program lets you gain proficiency in top tools. You will work on real-world projects in HTML5, creating sophisticated web applications</h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/ui-ux-design.jpg" />
                            </div>
                        </div>
                    </div>
                   <ul class="breadcrumb">
