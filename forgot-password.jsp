...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Admin - Techno Reach IT Solutions</title>
     <link rel="canonical" href="https://technoreachit.com/forgot-password.jsp">
    ...
    <div class="row">
        <div class="loginbg">
            <div class="row loginbodybg loginbtnclass">
               <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/ForgotPasswordService">
                <div class="col-xs-12 top-five bottom-fourty"><span class="loginheadtext"><img src="images/logo.png" style="width: 100%;" /></span></div>
                <div class="col-xs-12 top-five bottom-twenty"><input type="text" class="form-control" placeholder="Username" name="user" required></div>
                <div class="col-xs-12 top-five bottom-twenty"><input type="password" class="form-control" placeholder="New Password" name="newpassword" required></div>
                <div class="col-xs-12 bottom-twenty"><input type="password"  class="form-control" placeholder="Confirm Password" name="confirmpassword" required></div>
                <div class="col-xs-12 bottom-fourty"><button class="button">Submit</button></div>
                </form>
              <div class="col-xs-12 text-center bottom-ten signsubtext text-left"><a href="<%=request.getContextPath()%>/admin-login.jsp">Login?</a></div>
