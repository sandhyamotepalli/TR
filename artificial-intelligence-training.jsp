<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Artificial Intelligence");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Artificial Intelligence Training | Online Certification Course</title>
    <meta property="og:title" content="Artificial Intelligence Training | Online Certification Course"/>
	<meta property="og:url" content="https://www.technoreachit.com/artificial-intelligence-training.jsp"/>
	<meta property="og:description" content="The modules of this course includes Basics of Deep Learning Techniques, Machine Learning, Analytics vs Data Science and more with over 166 hours of classes."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/artificial-intelligence-training.jsp">
    <!-- Favicon -->
                            ...
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                        ...
                                        <!-- <h6 class="tr-font-white tr-tw-5"> Artificial Intelligence Master's course to become a certified Artificial Intelligence Engineer.</h6> -->
