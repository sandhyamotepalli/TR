<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Google Cloud Platform ( GCP) Admin");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Google Cloud Platform (GCP) Admin Certification Training | TechnoReach</title>
    <meta property="og:title" content="Google Cloud Platform (GCP) Admin Certification Training | TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/google-cloud-platform-training.jsp"/>
	<meta property="og:description" content="Learn Google Cloud Platform (GCP) online with 30hrs of classes along with practical projects."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/google-cloud-platform-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                        ...
                                        <!--<h6 class="tr-font-white tr-tw-5">Level up your cloud skills with the GCP Certification course</h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/google-cloud-platform.jpg" />
                            </div>
                        </div>
                    </div>
                   <ul class="breadcrumb">
