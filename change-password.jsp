...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Admin - Techno Reach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/change-password.jsp">
    ...
    <div class="row">
        <div class="loginbg">
            <div class="row loginbodybg loginbtnclass">
               <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/ChangePasswordService">
                <div class="col-xs-12 top-five bottom-fourty"><span class="loginheadtext"><img src="images/logo.png" style="width: 100%;" /></span></div>
                 <div class="col-xs-12 top-five bottom-twenty"><input type="password" class="form-control" placeholder="Old Password" name="oldpassword"></div>
                <div class="col-xs-12 top-five bottom-twenty"><input type="password" class="form-control" placeholder="New Password" name="newpassword"></div>
                <div class="col-xs-12 bottom-twenty"><input type="password"  class="form-control" placeholder="Confirm Password" name="confirmpassword"></div>
                <div class="col-xs-12 bottom-fourty"><button class="button">Submit</button></div>
                </form>
                <div class="col-xs-12 text-center bottom-ten signsubtext text-left"><a href="<%=request.getContextPath()%>/index-admin.jsp"><i class="fa fa-hand-o-left"></i>Go Back Home</a></div>
