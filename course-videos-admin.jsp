<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	ArrayList<AdminBean> trainerDetails = adminDao.getAllTrainers();
    %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="canonical" href="https://technoreachit.com/course-videos-admin.jsp">
    <!-- Favicon -->
...
{
	var path = "<%=request.getContextPath()%>/GetVideosToDownload?videoid="+vid+"";
...
viewList.onreadystatechange = function(){
    ...
    <script language="javascript" type="text/javascript">
var videosList = new XMLHttpRequest();
    function getVideosList(tid,tech){
    	var path = "<%=request.getContextPath()%>/GetVideosListToView?trainerid="+tid+"&tech="+tech+"";
    	videosList.open("post",path , true);
    	videosList.send(null);
    }
    videosList.onreadystatechange = function(){
    	if(videosList.readyState == 4){
    		var output = videosList.responseText;
    		if(output.charAt(0) === '<'){
    			document.getElementById("headingsList").innerHTML = output;
    		}else{
    			alert(output);
    			}
    	}
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right" id="top-menu">
                                ...
                                <li class="active"><a href="<%=request.getContextPath()%>/course-videos-admin.jsp">Course Videos</a></li>
    ...
    <div class="main-content">
        ...
        <section class="overview-block-ptb white-bg">
            <div class="container">
              ...
              <div class="row">
	            <div class="col-xs-12">
	            	<h5 class="tr-font-blue"><i class="fa fa-list"></i> List of Technologies</h5>
	            	<div class="tr-mb-10">
                    </div>
                    ...
                    if(trainerDetails != null && trainerDetails.size() > 0){
								for(int i=0;i<trainerDetails.size();i++)
								{
									 if (trainerDetails.get(i) != null)
									{
										 ...
										 trainerBean=new AdminBean();
										   	
										 trainerBean = trainerDetails.get(i);
										 
											 if (trainerBean.getTrainerid() != 0)
											 {%>
	            		                         <span onclick="getVideosList('<%=trainerBean.getTrainerid()%>','<%=trainerBean.getTrainingid()%>')"><%=trainerBean.getTechnology()%></span>
									      <%  }
							            }
									 trainerBean = null;
					 	          }
                         }else{%>
                          <p>Currently No Available Technologies.</p>
                          <% }
						%>
	            	</div>
	            </div>
               ...
               <div class="col-md-3 col-xs-12 videolist">
               <div>
