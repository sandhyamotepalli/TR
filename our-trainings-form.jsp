...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Post a Training | TechnoReach IT Solutions</title>
    <link rel="canonical" href="https://technoreachit.com/our-trainings-form.jsp">
    <!-- Favicon -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title tr-breadcrumb-title tr-mtb-100">
                            <h1 class="title tr-tw-8 tr-font-white">Post a Training</h1>
            ...
            <div class="container">
               <div class="row tr-mt-20">
                    <div class="contact-form">
                        <div class="col-sm-6">
                             <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/CreateTrainingService">
                                <div class="section-field">
                                    <input type="text" placeholder="Course Title" name="coursename" required>
                                </div>
                                  <div class="section-field">
                                    <input type="text" placeholder="Trainer Name" name="trainername" required>
                                </div>
                                <div class="section-field textarea">
                                    <textarea class="input-message" placeholder="Trainer Info" rows="7" name="trainerinfo" required></textarea>
                                </div>
                                 <div class="section-field">
                                    <input type="text" placeholder="Demo Link" name="link">
                                </div>
                                <div class="section-field">
                                    <input type="text" placeholder="Duration(in hrs)" name="duration" required pattern="[0-9]*$" title="Should be digits (0-9)">
                                </div>
                                 <div class="col-sm-6">
                                <div class="section-field">
                                    <input type="text" placeholder="Fees in INR" name="fees"  pattern="[0-9]*$" title="Should be digits (0-9)">
                                </div>
                                </div>
                                 <div class="col-sm-6">
                                 <div class="section-field">
                                    <input type="text" placeholder="Fees in USD" name="feeindollar"  pattern="[0-9]*$" title="Should be digits (0-9)">
                                </div>
                                </div>
                                ...
                                <div class="section-field">
                                    <input type="text" placeholder="4:00 PM to 6:00 PM IST" name="timings">
                                </div>
                                <div class="section-field">
                        ...
                        <div class="col-sm-6 text-center">
                            <img src="images/careers-right-side.png" style="width: 75%;">
                        </div>
                    </div>
                </div>
            </div>
