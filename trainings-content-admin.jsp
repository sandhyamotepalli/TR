<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	ArrayList<AdminBean> trainingDetails = adminDao.getAllTrainingContents();
    %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="canonical" href="https://technoreachit.com/trainings-content-admin.jsp">
    <!-- Favicon -->
...
function editTrainingContent(cid)
{
...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                             <ul class="nav navbar-nav navbar-right" id="top-menu">
                                ...
                                <li><a href="<%=request.getContextPath()%>/student-creation.jsp">Student Creation</a></li>
                                 <li class="active"><a href="<%=request.getContextPath()%>/trainings-content-admin.jsp">Training Content</a></li>
   ...
   <section class="tr-breadcrumb overview-block-pt text-center tr-bg tr-bg-fixed tr-over-black-90 tr-box-shadow" style="background: url(images/screens-images/ourtrainings-bg.jpg);" >
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title tr-breadcrumb-title tr-mtb-100">
                        <h1 class="title tr-tw-8 tr-font-white">Trainings Content</h1>
                        <div class="divider white"></div>
                    </div>
                    <ul class="breadcrumb">
                        <li><a href="<%=request.getContextPath()%>/index-admin.jsp"><i class="ion-home"></i> Home</a></li>
                        <li class="active">Trainings Content</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="main-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-right tr-mb-20">
                        <a class="button tr-mt-20" href="<%=request.getContextPath()%>/content-creation.jsp">Post Training Content</a>
                    </div>
                        <%
                         ...
                         <div class="iq-blog-detail">
                            <div class="blog-title"><h5 class="tr-tw-6">Course Name : <%=adminBean.getCoursename()%></h5></div>
                                <div class="blog-content">
                                	<small>Training Content :</small>
                                    <pre><%=adminBean.getTrainingcontent()%></pre>
                                </div>
                                <div class="blog-button">
                                    <a href="javascript:editTrainingContent('<%=adminBean.getContentid()%>');" class="pull-right iq-tw-6 text-primary" style="padding-right: 15px;">Edit <i class="fa fa-edit" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <form name="editform" id="editform" action="<%=request.getContextPath()%>/edit-training-content.jsp">
     <input type="hidden" name="cid" id="eid">
    </form>
      <div class="footer">
        <!-- Footer Start -->
