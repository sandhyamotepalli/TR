<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Blockchain");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Good Blockchain implementation & Training company in India</title>
    <meta property="og:title" content="Good Blockchain implementation & Training company in India"/>
	<meta property="og:url" content="https://www.technoreachit.com/blockchain-training.jsp"/>
	<meta property="og:description" content="TechnoReach's Blockchain Certification course helps you become an expert in Blockchain Technology. To gain practical experience sample projects will be shared by the mentors."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/blockchain-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!--<h6 class="tr-font-white tr-tw-5">Blockchain certification course offers a definitive training in the Blockchain technology.</h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/block-chain.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
