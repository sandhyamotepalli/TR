<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("Azure Infra Architect");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Microsoft Azure Infra Architect Training & Certification Course</title>
    <meta property="og:title" content="Microsoft Azure Infra Architect Training & Certification Course"/>
	<meta property="og:url" content="https://www.technoreachit.com/microsoft-azure-training.jsp"/>
	<meta property="og:description" content="In Microsoft Azure Infra Architect Certification Course, you will learn to configure and optimize Windows server workloads on Azure Platform and explore IaaS Architecture."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/microsoft-azure-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!--  <h6 class="tr-font-white tr-tw-5">Our Microsoft Azure Certification Architect master's course will help you be a complete Microsoft Azure Architect.</h6> -->
                                ...
                                <div class="row tr-mt-20 tr-coursedetails">
                                    ...
                                    <%if(adminBean != null && adminBean.getLink() != null && !adminBean.getLink().equalsIgnoreCase("")){%>
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/microsoft-azure.jpeg" />
                            </div>
                        </div>
                    </div>
                   <ul class="breadcrumb">
