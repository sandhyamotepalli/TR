<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    contentBean = adminDao.getTrainingContentDetailsByTrainingname("JAVA");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Good JAVA Training Institute in India| Online & Classroom|TechnoReach</title>
    <meta property="og:title" content="Good JAVA Training Institute in India| Online & Classroom|TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/java-training.jsp"/>
	<meta property="og:description" content="JAVA Training & Certification Course offers 24hrs of online or classroom training, get hands-on practical projects and Job Placement Assistance will be provided."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/java-training.jsp">
    <!-- Favicon -->
                            ...
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!-- <h6 class="tr-font-white tr-tw-5">Our Java certification training course lets you master the Java programming language.</h6>-->
