...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="canonical" href="https://technoreachit.com/our-payments.jsp">
    <!-- Favicon -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title tr-breadcrumb-title tr-mtb-100">
                            <h1 class="title tr-tw-8 tr-font-white">Our Payments</h1>
                            <div class="divider white"></div>
                        </div>
                    <ul class="breadcrumb">
                        <li><a href="<%=request.getContextPath()%>/index.jsp"><i class="ion-home"></i> Home</a></li>
                        <li class="active">Our Payments</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                 <div class="row tr-mt-20">
                    <div class="contact-form">
                        <div class="col-sm-6">
                           <form name ="paymentform" id ="paymentform" action="<%=request.getContextPath()%>/authorize_payment" method="post">
                                <div class="section-field">
                                    <input type="text" placeholder="Mobile Number" name="number"  id="order_id" required>
                                </div>
                                <div class="section-field">
                                    <input type="text" placeholder="Amount in USD" name="total" id="amount" required>
                                </div>
                                <div class="section-field textarea">
                                    <textarea class="input-message tr-mb-10" placeholder="Payment Purpose" rows="7" name="description" required=""></textarea>
                                </div>
                                <div class="section-field">
