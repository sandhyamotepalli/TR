<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("DataScience");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Data Science Training in India- (Data Scientist) | TechnoReach</title>
    <meta property="og:title" content="Data Science Training in India- (Data Scientist) | TechnoReach"/>
	<meta property="og:url" content="https://www.technoreachit.com/data-science-training.jsp"/>
	<meta property="og:description" content="In this course, you will learn the basics of Data Science, Data Science Deep Dive and more with over 35 hours of classes."/>
    ...
    <link rel="canonical" href="https://technoreachit.com/data-science-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                      ...
                                      <!--  <h6 class="tr-font-white tr-tw-5">Data Science course certification training lets you master in data analysis.</h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/data-science.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
