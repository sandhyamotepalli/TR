<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	AdminBean contentBean = new AdminBean();
	    contentBean = adminDao.getTrainingContentDetailsByTrainingname("BigData and Hadoop");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Big Data and Hadoop Training in New Jersey & India| Hadoop Learning</title>
    <meta property="og:title" content="Big Data and Hadoop Training in New Jersey & India| Hadoop Learning"/>
	<meta property="og:url" content="https://www.technoreachit.com/big-data-and-hadoop-training.jsp"/>
	<meta property="og:description" content="Master your skillset in Big Data and Hadoop. Over 60hrs of Online classes and honds-on live projects. Join Now!"/>
    ...
    <link rel="canonical" href="https://technoreachit.com/big-data-and-hadoop-training.jsp">
    <!-- Favicon -->
                    ...
                    <div class="heading-title tr-breadcrumb-title tr-mtb-50">
                        <div class="row">
                            <div class="col-md-8 text-left">
                                <div class="row">
                                    <div class="col-md-12 maincourse-wrap">
                                       ...
                                       <!-- <h6 class="tr-font-white tr-tw-5">This course helps you become a Big Data Administrator by learning concepts of Hadoop.</h6>-->
                            ...
                            <div class="col-md-4 maincourse-wrap">
                                <img src="../images/courses/bigdata-hadoop.jpg" />
                            </div>
                        </div>
                    </div>
                    <ul class="breadcrumb">
